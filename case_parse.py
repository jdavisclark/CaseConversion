...
# print(parseVariable('_Main_GUI_Screen_URL_',True))
# print(parseVariable('MAINGUISCREENURL',True))
# print(parseVariable('MainGUIScreenURL',True))
# print(parseVariable('MainGuiScreenUrl',True))
# print(parseVariable('mainGUIScreenURL',True))
# print(parseVariable('mainGuiScreenUrl',True))
# print(parseVariable('mainguiscreenurl',True))
# print(parseVariable('main_gui_screen_url',True))
# print(parseVariable('main-gui-screen-url',True))
# print(parseVariable('main.gui.screen.url',True))
# print(parseVariable('main/gui/screen/url',True))
# print(parseVariable('MAIN_GUI_SCREEN_URL',True))
# print(parseVariable('main_GUI_Screen_URL',True))
# print(parseVariable('main_GUI_Scr_een_URL',True))
# print(parseVariable('',True))
# print(parseVariable('_',True))

# (['Main', 'GUI', 'Screen', 'URL'], 'pascal', '_')
# (['Mainguiscreenurl'], 'upper', False)
# (['Main', 'GUI', 'Screen', 'URL'], 'pascal', False)
# (['Main', 'GUI', 'Screen', 'URL'], 'pascal', False)
# (['Main', 'GUI', 'Screen', 'URL'], 'camel', False)
# (['Main', 'GUI', 'Screen', 'URL'], 'camel', False)
# (['Mainguiscreenurl'], 'lower', False)
# (['Main', 'GUI', 'Screen', 'URL'], 'lower', '_')
# (['Main', 'GUI', 'Screen', 'URL'], 'lower', '-')
# (['Main', 'GUI', 'Screen', 'URL'], 'lower', '.')
# (['Main', 'GUI', 'Screen', 'URL'], 'lower', '/')
# (['Main', 'GUI', 'Screen', 'URL'], 'upper', '_')
# (['Main', 'GUI', 'Screen', 'URL'], 'camel', '_')
# (['Main', 'GUI', 'Scr', 'Een', 'URL'], 'mixed', '_')
# ([], 'unknown', False)
# ([], 'unknown', '_')
